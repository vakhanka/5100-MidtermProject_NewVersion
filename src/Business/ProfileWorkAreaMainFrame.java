...
public class ProfileWorkAreaMainFrame extends javax.swing.JFrame {
    ...
    private void LoginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginButtonActionPerformed
        ...
        char[] pwchar = pwField.getPassword();  // changing the password field from text to password in order to hide the password text
        String pw = new String(pwchar);
//      String pw = PasswordTextField.getText(); // old password text field disabled
        ...
        if (r.equals("Faculty")) {
            ...
            facultyworkarea = new FacultyWorkAreaJPanel(business, epp, CardSequencePanel);
            CardSequencePanel.removeAll();
    ...
    private void btnLogoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogoutActionPerformed
        // TODO add your handling code here:
        // Clear the credentials fields
    UserNameTextField.setText("");
    pwField.setText("");

    // Reset the right-side panel back to the welcome label
    CardSequencePanel.removeAll();
    CardSequencePanel.add(jLabel3, "card2");
    CardSequencePanel.revalidate();
    CardSequencePanel.repaint();

    // Hide logout, so the user can log back in
