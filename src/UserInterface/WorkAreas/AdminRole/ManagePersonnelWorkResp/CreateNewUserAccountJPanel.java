...
public class CreateNewUserAccountJPanel extends javax.swing.JPanel {
    ...
    // Verify the user doesn't exist already
        Person p = business.getPersonDirectory().findPerson(name);
        if (p!=null){
            JOptionPane.showMessageDialog(this, "User already exists."); // right now id is full name. should be changed to userID
            return;
        }
